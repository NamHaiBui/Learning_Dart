...
class Responder {
  ...
  static Future<Responder> create() async {
    // constructor are always synchronous so we need to create it as static
...
void _communicator(SendPort sp) async {
  ...
  await for (final message in messages) {
    for (final entry in messagesAndResposes.entries) {
...
const messagesAndResposes = {
  '': 'Ask mea questionlike "How are you?"',
  'Hello': 'Hi',
  'How are you': 'Fine',
